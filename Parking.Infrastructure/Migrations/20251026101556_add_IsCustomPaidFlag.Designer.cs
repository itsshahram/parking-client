...
namespace Parking.Infrastructure.Migrations
{
    ...
    [Migration("20251026101556_add_IsCustomPaidFlag")]
    partial class add_IsCustomPaidFlag
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Parking.Domain.Entities.ParkingTicket.TicketDescriptionItem", b =>
                {
                    ...
                    b.Property<int>("CurrentResetVersion")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Parking.Domain.Entities.Parkings.AddCardItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
